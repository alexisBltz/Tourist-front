...
import { inactivarUsuario, getUsuariosInactive, updateUsuarioRol } from "../../../service/usuarioService.ts";
...
const UsuariosInactive: React.FC = () => {
...
export default UsuariosInactive;
